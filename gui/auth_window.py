...
class AuthWindow:
    ...
    def register(self):
        ...
        user_id, username = AuthService.register(self.db, username, password)
        if user_id:
            self.show_message("Регистрация успешна! Теперь войдите.", "green")
            self.parent.after(500, lambda: self.tabview.set("Вход"))
